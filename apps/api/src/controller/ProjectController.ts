...
import { CreateProjectRequest, UpdateProjectRequest, Project as ProjectType } from "@construction/shared";
...
export class ProjectController {
    ...
    static create = async (req: Request, res: Response) => {
        try {
            const { name, address, description, status, startDate, endDate, latitude, longitude }: CreateProjectRequest = req.body;
    ...
    static update = async (req: Request, res: Response) => {
        try {
            const { id } = req.params;
            const { name, address, description, status, startDate, endDate, latitude, longitude }: UpdateProjectRequest = req.body;
    ...
    static addUnit = async (req: Request, res: Response) => {
        try {
            const { id } = req.params;
            const { name, blockNumber, unitType } = req.body;
