...
export default function AuthLayout({ children }: AuthLayoutProps) {
    return (
        <div className="flex w-full min-h-screen bg-background text-foreground transition-colors duration-300">
            ...
            <div className="w-full lg:w-2/5 flex flex-col bg-card shadow-[-10px_0_30px_rgba(0,0,0,0.05)] z-30 transition-colors duration-300">
                <header className="p-8 flex justify-end">
                    <LanguageSwitcher />
                </header>

                <main className="flex-1 flex items-center justify-center px-6 sm:px-12 md:px-20 lg:px-16 py-12">
                ...
                <footer className="p-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4 text-xs font-medium text-muted-foreground">
                    <div className="text-center sm:text-left">© 2026 BluePrint Sistem Manajemen Konstruksi</div>
