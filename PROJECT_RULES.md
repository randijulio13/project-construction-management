...
- **WAJIB** menerapkan prinsip **Mobile-First Design**.
- Gunakan utility classes Tailwind (misal: `md:`, `lg:`) untuk mengatur layout di berbagai ukuran layar.
- Pastikan semua elemen UI (tabel, form, modal) dapat diakses dengan baik di perangkat mobile.
- Gunakan komponen layout yang responsif dari shadcn/ui.
...
_Gunakan aturan ini setiap saat untuk menjaga kualitas kode yang tinggi._
